...
class Tooltip{
    ...
    constructor(width, height, color){
        ...
        this.triangle.setAttribute('points',`${this.width/2},${height} ${this.width-(roundness+this.width/2)},${height-this.y_offset-1} ${0+roundness+this.width/2},${height-this.y_offset-1}`)
...
class ScreenPane{
    ...
    constructor(){
        ...
        this.svg_canvas.style.zIndex = '100'
        this.mouse_on = null
